...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	var h1, t0, t1, t2, t3, t4, t5, button0, t7, button1, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h1, file, 18, 0, 188);
    			add_location(button0, file, 19, 0, 226);
    			add_location(button1, file, 24, 0, 287);
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      function decrementAge(){
    	...
    	return { name, age, incrementAge, decrementAge };
    }
